...
import { createUser } from "../../server/SignUp";
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // localStorage-ga user info va token saqla
    localStorage.setItem('user', JSON.stringify({
      id: res.data.id,
      name: res.data.name,
      email: res.data.email
    }));
    localStorage.setItem('token', 'user_token_' + res.data.id);
    ...
    toast.error(error.response?.data?.message || "Xatolik yuz berdi — Email allaqachon ro'yxatdan o'tgan bo'lishi mumkin");
  }
};
